...
namespace Phenicienn.Migrations
{
    ...
    [Migration("20200908224217_FixOrderItemRels1")]
    partial class FixOrderItemRels1
    {
            ...
            modelBuilder.Entity("Phenicienn.Models.OrdersItems", b =>
                {
                    ...
                    b.Property<int?>("FK_ORDERSITEMS_ITEM_CUSTOM")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FK_ORDERSITEMS_ITEM_CUSTOM")
                        .IsUnique()
                        .HasFilter("[FK_ORDERSITEMS_ITEM_CUSTOM] IS NOT NULL");
            ...
            modelBuilder.Entity("Phenicienn.Models.OrdersItems", b =>
                {
                    b.HasOne("Phenicienn.Models.Item", "Item")
                        .WithOne()
                        .HasForeignKey("Phenicienn.Models.OrdersItems", "FK_ORDERSITEMS_ITEM_CUSTOM")
